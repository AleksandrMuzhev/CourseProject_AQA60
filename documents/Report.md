...
![ОтчетAllure](img_3.png)

Из общего числа выполненных тестов 26 завершились успешно, что составляет приблизительно 72% от общего количества тест-кейсов. 10 тестов завершились с ошибками, что составляет приблизительно 28% от общего количества тест-кейсов.
